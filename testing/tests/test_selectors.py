...
def test_tool_pairs():
    ...
    assert (
        tool_pairs[0][0]["id"] == "1"
        and tool_pairs[0][0]["function"]["name"] == "func1"
    )
    assert (
        tool_pairs[0][1]["id"] == "1" and tool_pairs[0][1]["content"] == "Tool output 1"
    )
    assert (
        tool_pairs[1][0]["id"] == "2"
        and tool_pairs[1][0]["function"]["name"] == "func2"
    )
    assert (
        tool_pairs[1][1]["id"] == "2" and tool_pairs[1][1]["content"] == "Tool output 2"
    )
